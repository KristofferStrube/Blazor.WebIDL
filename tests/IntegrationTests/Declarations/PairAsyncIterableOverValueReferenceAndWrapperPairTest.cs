...
[TestFixture("Chrome")]
[TestFixture("Firefox")]
public class PairAsyncIterableOverValueReferenceAndWrapperPairTest(string browserName) : BlazorTest(browserName)
{
    ...
    {
        // Act
        await using AsyncIterator<ValueReference, FileSystemHandle> iterator = await opfs.EntriesAsync(
            disposePreviousValueWhenMovingToNextValue: false);
    ...
    [IJSWrapperConverter]
    public class FileSystemDirectoryHandle : FileSystemHandle, IJSCreatable<FileSystemDirectoryHandle>, IPairAsyncIterable<FileSystemDirectoryHandle, ValueReference, FileSystemHandle>
    {
        /// <inheritdoc/>
